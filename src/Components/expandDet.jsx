  ...
  return (
    <div>
      <div>
        <h2>
          <button
            className="font-bold text-left text-white flex items-center justify-between bg-red-500 w-full mb-4 h-11 p-4"
            type="button"
            onClick={toggleAccordion}
          >
            <span className="text-white">{data.displayName}</span>
            <span className="w-6 h-6 rounded-full bg-red-700 text-white flex items-center justify-center ml-2">
              {total}
            </span>
